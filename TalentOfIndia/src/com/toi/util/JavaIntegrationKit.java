...
public class JavaIntegrationKit {
	...
	String key = "XXXXXXXXXXXXX"; // your key
        String salt = "xxxxxxxxxxxxx"; // your salt
        String action1 = "";
        //String base_url = "https://secure.payu.in";
        String base_url = "https://sandboxsecure.payu.in";
        error = 0;
        String hashString = "";
        Enumeration paramNames = request.getAttributeNames();  //request.getParameterNames();
        ...
        while (paramNames.hasMoreElements()) {
           ...
           // System.out.println(paramName+"......"+request.getAttribute(paramName));
            params.put(paramName, String.valueOf(request.getAttribute(paramName)));
        }
